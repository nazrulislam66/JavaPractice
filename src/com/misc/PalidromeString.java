...
//the same as the original string. For example, radar, level, etc.
public class PalidromeString {
	...
	public String isPalidrom(String pal) {
...
/*
 * In the above example, we have a string "Radar" stored in str. Here, we have
 * used the
 * 
 ...
 * accessed in reverse order and stored in reverseStr.
 * 
